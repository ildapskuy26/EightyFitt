    ...
    <span class="badge bg-success-subtle text-success border border-success px-2 py-1">
            ...
            <form method="GET" action="{{ route('kunjungan.index') }}">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="jurusan" class="form-control" value="{{ request('jurusan') }}">
                    </div>
                    <div class="mb-3">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content shadow-lg">
            <div class="modal-header">
                <h5 class="modal-title fw-bold"><i class="bi bi-filetype-csv me-2"></i>Ekspor Data Kunjungan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
